...
def write_report(path: str, obj) -> None:
...
def find_test(test_id, obj_list: list) -> str:
    result = ''
    for obj in obj_list:
...
def forming_report(values: dict, tests: list) -> dict:
    for obj in tests:
        if isinstance(obj, dict):
...
def main(test_result_path: str, tests_template_path: str, report_path: str) -> None:
